...
def best_first_search(initial_state, goal_state):
    frontier = []
    heapq.heappush(frontier, (heuristic(initial_state, goal_state), initial_state, [initial_state]))
    explored = set()
    ...
    while frontier:
        ...
        for successor in get_successors(state):
            heapq.heappush(frontier, (heuristic(successor, goal_state), successor, path + [successor]))
